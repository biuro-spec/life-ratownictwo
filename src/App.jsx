    ...
    <div className="container mx-auto px-4">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 items-start">
        <div className="col-span-1 lg:col-span-1">
          <div className="mb-6"><span className="text-white font-bold text-2xl">LIFE</span></div>
          <p className="text-base leading-relaxed mb-6">Profesjonalna opieka medyczna i transport sanitarny. Działamy z misją i pasją od 2012 roku.</p>
        ...
        <div>
          ...
          <ul className="space-y-3">
            ...
            <li><Link to="/kpp" className="hover:text-primary-red transition-colors text-sm">Kurs KPP</Link></li>
      ...
      <div className="pt-10 text-center text-xs opacity-50 border-t border-white/5">
        &copy; 2025 LIFE-Ratownictwo Medyczne i Pielęgniarstwo Sp. z o.o. | NIP: 6392023251 | KRS: 0000920762 | REGON: 389900423 &middot; Podmiot leczniczy wpisany do rejestru MZ
      </div>
